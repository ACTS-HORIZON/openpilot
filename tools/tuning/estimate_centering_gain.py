...
class CenteringGainEstimator:
  ...
  def analyze(self):
    ...
    print(f"  selfdrive/controls/lib/latcontrol_torque.py")

    if r_squared < 0.3:
      print(f"\n  NOTE: Low R² ({r_squared:.2f}) suggests the centering force")
      print(f"  may be weak or the data is noisy. Consider more data or")
      print(f"  setting K_CENTERING_ANGLE = 0.0 to disable.")
