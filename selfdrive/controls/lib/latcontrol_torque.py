...
KP_INTERP = [250, 120, 65, 30, 11.5, 5.0, 2.8, 1.4, KP]
KD_INTERP = [0, 0, 0, 0, 0.02, 0.05, 0.08, 0.12, KD]

LP_FILTER_CUTOFF_HZ = 0.8
...
class LatControlTorque(LatControl):
  ...
  def update(self, active, CS, VM, params, steer_limited_by_safety, desired_curvature, calibrated_pose, curvature_limited, lat_delay):
    ...
    if not active:
      ...
      measurement_rate = self.measurement_rate_filter.update((measurement - self.prev_measurement) / self.dt)
